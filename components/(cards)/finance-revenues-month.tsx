    ...
    return (
        <View style={[tw`p-5 rounded-xl`, { backgroundColor: '#B9B9C9' }]}>
            ...
            <View style={[tw`flex-row justify-between items-center`]}>
                <Text style={[tw`text-base`, {color: 'black'}]}>Плановый Доход:</Text>
                <Text style={[tw`text-base font-bold text-black`]}>3 500 000 сум</Text>
            </View>
            <View style={[tw`flex-row justify-between items-center`]}>
                <Text style={[tw`text-base`, {color: 'black'}]}>Рабочие часы:</Text> 
                <Text style={[tw`text-base font-bold text-black`]}>10</Text>
            </View>
            <View style={[tw`flex-row justify-between items-center`]}>
                <Text style={[tw`text-base`, {color: 'black'}]}>Сеансов выполнено:</Text> 

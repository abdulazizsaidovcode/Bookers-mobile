...
export const postOrder = async ({ data, status = "OTHER", messageSatus, setOrderId, setLoading, setStatus, navigation }: OrderPost) => {
    try {
...
export const orderTimeEdit = async ({ data, setOrderId, setLoading }: { data: any, setOrderId: (val: string) => void, setLoading: (val: boolean) => void }) => {
    try {
        setLoading(true);

...
const ClientPage: React.FC = () => {
    ...
    const handlePress = (clientType: string) => {
        // navigation.navigate('ClientDetails', { type: clientType });
    };

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.header}>salom</Text>
      <TouchableOpacity style={styles.item} onPress={() => handlePress('all')}>
      ...
      <TouchableOpacity style={styles.item} onPress={() => handlePress('addressBook')}>
        <View style={styles.itemContent}>

                        ...
                        >
                            <View style={tw`p-4 text-center`}>
                                {loading ? (
                                    ...
                                    <>
                                        <Text style={tw`text-white text-xl w-full text-2xl`}>Здоровье и красота
                                            волос</Text>
                                        <Text style={tw`text-center text-white text-xl`}>В эту категорию входят услуги
                                            таких специализаций как:</Text>
                                        {childCategoryData.length > 0 ? (
                                            ...
                                            <Text style={tw`text-center text-gray-600 text-xl mb-2`}>Информация
                                                недоступна</Text>
                                        )}
                                    </>
                                )}
